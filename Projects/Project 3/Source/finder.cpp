...
int find_solver(double dt, int numTimesteps) {
	...
	vec3 angular_momentum_start;
	vec3 angular_momentum_end;
	//double total_kinetic_energy_start;
	//double total_kinetic_energy_end;
	//double total_potential_energy_start;
	//double total_potential_energy_end;
